...
def _resolve_gld_image(image_id: str) -> str:
    """Locate GLD image across splits; handles .jpg/.JPEG."""
    ...
    raise FileNotFoundError(
        f"GLD image {image_id} not found under {GLD_image_path}/(train|test|index)"
    )
...
def get_image(image_id, dataset_name, iNat_id2name=None):
    ...
    if dataset_name == "inaturalist":
        ...
        image_path = _resolve_gld_image(image_id)
